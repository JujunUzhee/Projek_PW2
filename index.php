    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-md-6 bg-login">
                <h2 class="text-center pt-4 teks-login">Silakan Login</h2>
                <form action="login.php" method="POST">
                    <?php
                    if (isset($_GET['error'])) {
                        echo '<div class="text-center error">Username atau password salah!</div>';
                    }
                    ?>
                ...
                <div class="text-center">
                    <p>Belum punya akun? <a href="signup.php">Daftar Akun Baru</a></p>
                </div>
            </div>
        </div>
    </div>
